        ...
        {!aside?.display && (
          <div className='d-flex align-items-center flex-grow-1 flex-lg-grow-0'>
            <Link href='/' className='d-lg-none'>
              <img alt='Logo' src='/logo/logo-circle.png' className='h-20px' />
            </Link>
          </div>
        )}
        {/* end::Logo */}
            ...
            {logoReplacement ? (
              ...
              <Link href='/' className='d-flex d-lg-none align-items-center flex-lg-grow-0'>
                {canMobilePageGoBack?.status ? (
                  ...
                  <img alt='Logo' src='/logo/logo-circle.png' className='h-15px' />
                )}
              </Link>
            )}
          </>
          ...
          <div className='d-flex flex-lg-grow-1 align-items-center'>
            ...
            <div className='header-left'>
              <Link href='/' className='d-none d-lg-flex flex-shrink'>
                <img src='/logo/logo-circle.png' alt='' className='' />
              </Link>
            </div>
            {header.left === 'menu' && (
              <div className='d-flex align-items-stretch' id='kt_header_nav'>
                <div
                  ...
                  <div
                    ...
                    <Link href='/oke' scroll={false} className='d-flex flex-center'>
                      test3
                    </Link>
                    {/* <Link
                      style={menuStyle}
