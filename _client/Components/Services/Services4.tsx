        ...
        <div className='row'>
          <div className='col-lg-8 m-auto text-center'>
            <div className='heading4'>
              <SectionTitle2 SubTitle='Our Service 👋' Title='Our Products'></SectionTitle2>
            </div>
          </div>
        </div>
          ...
          {data.map((item, i) => (
            <div
              ...
              <div className={item.addClass}>
                ...
                <div className='heading4'>
                  <h4>
                    <Link href={item?.btnLink || '/'}>{parse(item.title)}</Link>
                  </h4>
                  <div className='space16'></div>
                  <p>{item.desc} </p>
                  <div className='space16'></div>
                  <Link href={item?.btnLink || '/'} className='learn-btn'>
                    Read More
                    <span>
